...
create procedure raise_salary(@raise float, @salary float output) --raise este un numar pozitiv subunitar
as
begin
...
begin
	...
	begin
		--update Employee set salariu = @salariu + 15.0/100 * @salariu where current of cursor_employees -- atentie!! 10 / 100 se interpreteaza ca parte intreaga: [10/100]
		update Employee set salariu = salariu + 15.0/100 * salariu where current of cursor_employees -- atentie!! 10 / 100 se interpreteaza ca parte intreaga: [10/100]
		select * from Employee
	end
