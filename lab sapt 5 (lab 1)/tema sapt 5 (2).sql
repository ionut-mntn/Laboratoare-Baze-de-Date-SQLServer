...
-- selecteaza-mi CNP-urile oricaror 5 sportivi care incep antrenamentul mai devreme de ora 12
...
-- selecteaza toate specializarile si afiseaza unde au sediile. Afiseaza si adresele la care nu se afla biroul vreunui club de o specializare.
...
--========================================================================
select avg(s.greutate) as inaltime_medie, COUNT(s.CNP) as nr_sportivi--, s.greutate
from Sportiv s
join Antrenament a on a.CNP = s.CNP
join Locatie l on a.id_locatie = l.id_locatie
where l.denumire = 'bazin'
