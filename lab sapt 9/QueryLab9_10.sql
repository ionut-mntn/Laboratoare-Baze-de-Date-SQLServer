...
begin
	...
	begin
		set @salariu = @salariu + 0.10 * @salariu
	end
...
begin
	exec raise_salary @departament, @salariu output -- trebuie precizat si in apel ca e parametru de intrare prin referinta!! adica output asta
	print @salariu
	update Employee set salariu = @salariu where current of cursor_employees
