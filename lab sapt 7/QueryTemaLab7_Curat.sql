...
exec goToVersion 0 -- inainte de 
select * from VersionNr
select * from History
select * from rollbackHelper

exec goToVersion 5 -- inainte de 
select * from VersionNr
select * from History
select * from rollbackHelper

drop table proba2 -- dc uneori tre sa pun ghilimele alteori nu??
exec createTable 'proba2', 'ceva', 'int' -- pot incerca un try-except in procedura ca sa nu imi puna in tabele dar sa imi dea eroare la creare
select * from VersionNr
select * from History
select * from rollbackHelper

exec goToVersion 1 -- inainte de 
select * from VersionNr
select * from History
select * from rollbackHelper

exec goToVersion 6 -- inainte de 
select * from VersionNr
select * from History
select * from rollbackHelper
