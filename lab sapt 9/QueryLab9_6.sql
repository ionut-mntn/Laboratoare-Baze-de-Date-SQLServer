...
begin
	...
	begin
		print 'salariu bre'
		print @salariu
		update Employee set salariu = @salariu + 0.1 * @salariu where current of cursor_employees -- atentie!! 10 / 100 se interpreteaza ca parte intreaga: [10/100]
		select * from Employee
		/*
		update Employee
		set salariu = @salariu + 10/100 * @salariu -- stie doar de variabilele salariu aici in fetchurile astea!!
		select * from Employee
		*/
	end
	/*
